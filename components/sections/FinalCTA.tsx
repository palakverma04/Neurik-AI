...
export function FinalCTA({ title, description, ctas, tone = "default" }: FinalCTAProps) {
    ...
    <SectionWrapper tone={isLight ? "light" : "default"}>
      <div
        className={cn(
          ...
          isLight
            ? "section-inset-dark"
            : "glass-panel group transition-[border-color,box-shadow] duration-500 hover:border-foreground/25 hover:shadow-[inset_0_1px_0_rgba(255,246,246,0.16),0_20px_56px_rgba(0,0,0,0.32),0_0_48px_rgba(255,246,246,0.06)]",
        )}
      >
        {!isLight && (
          <>
            ...
            {ctas.map((cta) => (
              <Button
                ...
                className={
                  isLight
                    ? undefined
                    : "backdrop-blur-sm transition-transform duration-300 hover:scale-[1.02] hover:shadow-[0_0_24px_rgba(255,246,246,0.12)]"
                }
              >
                {cta.label}
              </Button>
