  ...
  return (
    <SectionWrapper tone="surface" className="py-14 md:py-20">
      <div className="max-w-3xl">
        ...
        <p className="mt-4 leading-relaxed text-muted">{showcase.description}</p>
      </div>
        ...
        {showcase.images.map((image) => (
          ...
          >
            <img
              ...
              loading="lazy"
            />
            <figcaption className="border-t border-surface-border bg-background/80 px-4 py-3 text-sm text-muted">
              {image.label}
            </figcaption>
          </figure>
        ))}
